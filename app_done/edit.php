...
try {
    ...
    $sql = "SELECT * FROM app_done where id_app= ?";
    $stmt = $db->prepare($sql);
...
<div class="card">
  <h5 class="card-header bg-success text-white">Edit App Done</h5>
  <div class="card-body">
    <form action="../controller/UpdateAppDoneController.php" method="post">
    <input type="hidden" value="<?php echo $id;?>" name="id_app">
    <?php 
            require_once("../config.php");
        ...
        <label>Tanggal</label>
            ...
            <div class="card-text">
                ...
                <a href="../app_done" class="btn btn-secondary btn-xs mt-4">Batal</a>
            </div>
        </div>
    </div>
