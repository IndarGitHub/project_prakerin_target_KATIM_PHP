...
try {
    ...
    $sql = "SELECT * FROM jml_staff where id_jml= ?";
    $stmt = $db->prepare($sql);
...
<div class="card">
  <h5 class="card-header bg-success text-white">Buat Nett Margin</h5>
  <div class="card-body">
    <form action="../controller/UpdateJmlStaffController.php" method="post">
        <?php 
            require_once("../config.php");
        ...
        ?>
        <input type="hidden" value="<?php echo $id;?>" name="id_jml">
            <label >Tanggal</label>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" value="<?php echo $kw4; ?>" name="kw4" id="jumlah_staff_kw4">
            ...
            <div class="card mt-4">
                ...
                <div class="card-text">
                    ...
                    <input type="text" class="form-control" name="kw1" value="<?php echo $kw1; ?>" id="jumlah_staff_kw1">
            ...
            <div class="card mt-4">
                ...
                <div class="card-text">
                    ...
                    <input type="text" class="form-control" name="kw2" value="<?php echo $kw2; ?>" id="jumlah_staff_kw2">
        ...
        <a href="../jml_staff" class="btn btn-secondary btn-xs mt-4">Batal</a>
    </form>
  </div>
</div>
</div>
